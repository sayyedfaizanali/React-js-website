...
function Hooks() {
  return (
    <>
      <h4>
        <Link to="/reference/react">API REFERENCE &nbsp; {">>"}</Link>
      </h4>
      <div className="container-fluid fluid">
        <div className="container">
          <h1>Built-in React Hooks</h1>
          <p className="fluid-para">
            <strong>
              Hooks let you use different React features from your components.
              You can either use the built-in Hooks or combine them to build
              your own. This page lists all built-in Hooks in React.
            </strong>
          </p>
          <hr></hr>
          ...
          <p className="fluid-para">
            ...
            example, a form component can use state{" "}
          </p>
          <p className="fluid-para">
          ...
          <ul>
            <li>
              useRef declares a ref. You can hold any value in it, but most
              often it’s used to hold a DOM node.
            </li>
            <li>
